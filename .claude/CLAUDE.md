...
2. 改完 commit + push
3. 開 PR 到 develop，通知 maintainer review
4. maintainer approve 後 merge 到 develop
5. develop 穩定後，maintainer 決定 merge 到 main 上線
...
2. PR 描述必須包含：
   ...
   - **可能風險**：如果有潛在問題
3. PR 開完後通知 maintainer，只發 PR 連結 + 一行摘要
4. 主動做完整個流程
